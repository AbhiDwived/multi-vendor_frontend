            ...
            <div className='max-w-[1440px] px-16 sm:px-5 md-lg:px-12 md:px-10 flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        <img className='w-[120px] h-[70x]' src="/images/FOSP-Logo.png" alt="logo" />
                        <ul className='flex flex-col gap-2 text-slate-700'>
                            <li>Address : Deoria , Uttar Pardesh</li>
                            <li>Phone : +91 8433208146</li>
                            <li>Email : abhidwivedi687@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        ...
                        <span className='text-slate-700'>Get Email updates about our latest and shop specials offers</span>
